...
本列表翻译自[awesome-raspberry-pi](https://github.com/thibmaek/awesome-raspberry-pi) ⭐ 16,885 | 🐛 28 | 🌐 Shell | 📅 2026-07-27 ，是由 [thibmaek](https://github.com/thibmaek) 发起并维护的树莓派资源列表，内容包括树莓派相关的工具、项目、系统镜像、社区及其他一些资源。

Awesome-XXX 是GitHub上知名的一组项目，其主页：[Awesome 清单](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 507,351 | 🐛 106 | 📅 2026-09-02
...
* [motionEyeOS](https://github.com/ccrisan/motioneyeos/wiki) ⭐ 8,213 | 🐛 840 | 🌐 Makefile | 📅 2025-02-14 - 将微型计算机打造为视频监控系统的Linux发行版。
...
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,259 | 🐛 166 | 🌐 Shell | 📅 2026-09-16 - 用于构建树莓派官方镜像的工具. 你可以将其用于构建自己的定制镜像（预装特定软件）
...
* [Smart Mirror](https://github.com/evancohen/smart-mirror) ⭐ 2,821 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-17 - 带语音控制智能镜子，集成物联网. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
