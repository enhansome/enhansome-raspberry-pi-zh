...
本列表翻译自[awesome-raspberry-pi](https://github.com/thibmaek/awesome-raspberry-pi) ⭐ 16,905 | 🐛 28 | 🌐 Shell | 📅 2026-07-27 ，是由 [thibmaek](https://github.com/thibmaek) 发起并维护的树莓派资源列表，内容包括树莓派相关的工具、项目、系统镜像、社区及其他一些资源。

Awesome-XXX 是GitHub上知名的一组项目，其主页：[Awesome 清单](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 508,845 | 🐛 106 | 📅 2026-09-02
...
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,260 | 🐛 166 | 🌐 Shell | 📅 2026-09-16 - 用于构建树莓派官方镜像的工具. 你可以将其用于构建自己的定制镜像（预装特定软件）
...
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 12,146 | 🐛 32 | 🌐 C++ | 📅 2026-09-20 - 让大家能够通过制作音乐来学习编程的一款音乐合成器

* [Smart Mirror](https://github.com/evancohen/smart-mirror) ⭐ 2,822 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-17 - 带语音控制智能镜子，集成物联网. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
...
* [Moonlight](https://github.com/irtimmer/moonlight-embedded) ⭐ 1,660 | 🐛 121 | 🌐 C | 📅 2026-06-06 - 嵌入式系统的Gamestream客户端（把电脑主机的游戏串流到树莓派，然后输出到电视玩）
