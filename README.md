...
本列表翻译自[awesome-raspberry-pi](https://github.com/thibmaek/awesome-raspberry-pi) ⭐ 16,923 | 🐛 31 | 🌐 Shell | 📅 2026-07-27 ，是由 [thibmaek](https://github.com/thibmaek) 发起并维护的树莓派资源列表，内容包括树莓派相关的工具、项目、系统镜像、社区及其他一些资源。

Awesome-XXX 是GitHub上知名的一组项目，其主页：[Awesome 清单](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 510,739 | 🐛 107 | 📅 2026-09-02
...
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,262 | 🐛 166 | 🌐 Shell | 📅 2026-09-16 - 用于构建树莓派官方镜像的工具. 你可以将其用于构建自己的定制镜像（预装特定软件）
...
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 12,156 | 🐛 34 | 🌐 C++ | 📅 2026-09-24 - 让大家能够通过制作音乐来学习编程的一款音乐合成器

* [Smart Mirror](https://github.com/evancohen/smart-mirror) ⭐ 2,822 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-26 - 带语音控制智能镜子，集成物联网. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)

* [Sonus](https://github.com/evancohen/sonus) ⭐ 638 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-11 - 开源、跨平台的语音识别框架（Google Cloud Speech）

* [PiClock](https://github.com/n0bel/PiClock) ⭐ 588 | 🐛 2 | 🌐 Python | 📅 2026-08-28 - 别致的时钟
...
* [Moonlight](https://github.com/irtimmer/moonlight-embedded) ⭐ 1,662 | 🐛 121 | 🌐 C | 📅 2026-06-06 - 嵌入式系统的Gamestream客户端（把电脑主机的游戏串流到树莓派，然后输出到电视玩）
