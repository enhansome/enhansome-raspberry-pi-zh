...
本列表翻译自[awesome-raspberry-pi](https://github.com/thibmaek/awesome-raspberry-pi) ⭐ 16,748 | 🐛 17 | 🌐 Shell | 📅 2026-07-27 ，是由 [thibmaek](https://github.com/thibmaek) 发起并维护的树莓派资源列表，内容包括树莓派相关的工具、项目、系统镜像、社区及其他一些资源。

Awesome-XXX 是GitHub上知名的一组项目，其主页：[Awesome 清单](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 496,714 | 🐛 100 | 📅 2026-06-30
...
* [motionEyeOS](https://github.com/ccrisan/motioneyeos/wiki) ⭐ 8,210 | 🐛 840 | 🌐 Makefile | 📅 2025-02-14 - 将微型计算机打造为视频监控系统的Linux发行版。
...
* [PiShrink](https://github.com/Drewsif/PiShrink/) ⭐ 4,093 | 🐛 21 | 🌐 Shell | 📅 2026-05-10 - Bash脚本，它会自动缩小pi镜像，之后在启动时将其调整为SD卡的最大存储空间大小
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,227 | 🐛 167 | 🌐 Shell | 📅 2026-06-19 - 用于构建树莓派官方镜像的工具. 你可以将其用于构建自己的定制镜像（预装特定软件）
...
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 12,070 | 🐛 24 | 🌐 C++ | 📅 2026-08-12 - 让大家能够通过制作音乐来学习编程的一款音乐合成器
...
* [PiClock](https://github.com/n0bel/PiClock) ⭐ 589 | 🐛 39 | 🌐 Python | 📅 2024-07-15 - 别致的时钟

* [SecPi](https://github.com/SecPi/SecPi) ⭐ 263 | 🐛 32 | 🌐 Python | 📅 2022-11-23 - 基于Raspberry Pi的家庭报警系统.
...
* [Moonlight](https://github.com/irtimmer/moonlight-embedded) ⭐ 1,653 | 🐛 121 | 🌐 C | 📅 2026-06-06 - 嵌入式系统的Gamestream客户端（把电脑主机的游戏串流到树莓派，然后输出到电视玩）
